...
class DepartmentController extends Controller
{
    ...
    var $path_view = 'master.department';

    function __construct()
    {
        $this->middleware('permission:master_department-list|permission-create|master_department-edit|master_department-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_department-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_department-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_department-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    {
        $items = Department::findOrFail($id);
