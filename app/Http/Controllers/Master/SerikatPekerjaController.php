...
class SerikatPekerjaController extends Controller
{
    var $route = 'unions';
    var $path_view = 'master.serikat_pekerja';

    function __construct()
    {
        $this->middleware('permission:master_serikat_pekerja-list|permission-create|master_serikat_pekerja-edit|master_serikat_pekerja-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_serikat_pekerja-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_serikat_pekerja-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_serikat_pekerja-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'serikat_pekerja' => 'required|unique:unions,serikat_pekerja',
        ]);

        try{
            $data['serikat_pekerja'] = $request->serikat_pekerja;
            $data['alamat'] = $request->alamat;
            $data['latitdue'] = $request->latitude;
            $data['longitude'] = $request->longitude;
            $create = Union::create($data);
