...
{
    var $route = 'type_bloods';
    var $path_view = 'master.type_blood';

    function __construct()
    {
        $this->middleware('permission:master_golongan_darah-list|permission-create|master_golongan_darah-edit|master_golongan_darah-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_golongan_darah-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_golongan_darah-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_golongan_darah-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'golongan_darah' => 'required|unique:type_bloods,golongan_darah',
        ]);

        try{
            $data['golongan_darah'] = $request->golongan_darah;
            $data['description'] = $request->description;
            $create = TypeBlood::create($data);
