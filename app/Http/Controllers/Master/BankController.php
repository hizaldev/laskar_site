...
{
    var $route = 'banks';
    var $path_view = 'master.bank';

    function __construct()
    {
        $this->middleware('permission:master_bank-list|permission-create|master_bank-edit|master_bank-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_bank-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_bank-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_bank-delete', ['only' => ['destroy']]);
    }
    /**
