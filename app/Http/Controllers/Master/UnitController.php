...
{
    var $route = 'units';
    var $path_view = 'master.unit';

    function __construct()
    {
        $this->middleware('permission:master_unit-list|permission-create|master_unit-edit|master_unit-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_unit-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_unit-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_unit-delete', ['only' => ['destroy']]);
    }
    /**
