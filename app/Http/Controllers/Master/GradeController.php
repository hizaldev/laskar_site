...
{
    var $route = 'grades';
    var $path_view = 'master.grade';

    function __construct()
    {
        $this->middleware('permission:master_grade-list|permission-create|master_grade-edit|master_grade-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_grade-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_grade-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_grade-delete', ['only' => ['destroy']]);
    }
    /**
