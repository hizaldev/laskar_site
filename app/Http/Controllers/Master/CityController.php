...
{
    var $route = 'cities';
    var $path_view = 'master.city';

    function __construct()
    {
        $this->middleware('permission:master_kota-list|permission-create|master_kota-edit|master_kota-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_kota-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_kota-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_kota-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'kota' => 'required|unique:Cities,kota',
        ]);
