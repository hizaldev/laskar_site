...
{
    var $route = 'sizes';
    var $path_view = 'master.size';

    function __construct()
    {
        $this->middleware('permission:master_ukuran-list|permission-create|master_ukuran-edit|master_ukuran-delete', ['only' => ['index','store']]);
        $this->middleware('permission:master_ukuran-create', ['only' => ['create','store']]);
        $this->middleware('permission:master_ukuran-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:master_ukuran-delete', ['only' => ['destroy']]);
    }
    /**
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'ukuran' => 'required|unique:Sizes,ukuran',
        ]);

        try{
            $data['ukuran'] = $request->ukuran;
            $data['description'] = $request->description;
            $create = Size::create($data);
