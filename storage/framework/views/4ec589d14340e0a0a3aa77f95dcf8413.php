            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('members.update', $item->id)); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($item->no_pendaftaran); ?>" name="no_pendaftaran" id="no_pendaftaran" placeholder="Masukan Nomor Pendaftaran" readonly>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="status_id" class="form-control form-select-sm <?php $__errorArgs = ['status_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="status_id" required>
                                            <option value="">-- Pilih Unit --</option>
                                            <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($stat->id); ?>" <?php echo e($stat->id == $item->status_id ? 'selected' : ''); ?>><?php echo e($stat->status); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alfbriatna/sites/project/laskar_site/resources/views/keanggotaan/anggota/edit.blade.php ENDPATH**/ ?>