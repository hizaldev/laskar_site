            ...
            <div class="col-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('dpc.update', $item->id)); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" id="select2" required>
                                    ...
                                    <?php $__currentLoopData = $dpd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($d->id); ?>" <?php echo e($d->id == $item->dpd_id ? 'selected' : ''); ?>><?php echo e($d->dpd); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['dpd'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($item->dpc); ?>" name="dpc" id="dpc" placeholder="masukan Nama DPC">
                                <?php $__errorArgs = ['dpc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alfbriatna/sites/project/laskar_site/resources/views/master/dpc/edit.blade.php ENDPATH**/ ?>