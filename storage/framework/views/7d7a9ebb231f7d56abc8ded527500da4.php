<?php $__env->startSection('content'); ?>
    ...
    <div class="container-lg">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Manage Role</strong></div>
                    <div class="card-body">
                        <?php if($errors->any()): ?>
                        ...
                        <form action="<?php echo e(route('roles.update', $role->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="<?php echo e($role->name); ?>" id="exampleInputName1" placeholder="Enter Role Name">
                            </div>
                            <div class="row">
                                                            ...
                                                            <?php if($data[0] == $filter[0]): ?>
                                                                <div class="col-3">
                                                                    <div class="form-check mb-3">
                                                                        <input class="form-check-input" type="checkbox" id="flexCheckChecked<?php echo e($permit->id); ?>" name="permission[]" value="<?php echo e($permit->id); ?>" <?php echo e(in_array($permit->id, $rolePermissions) ? 'checked' : ''); ?>>
                            ...
                            <a href="#" class="btn btn-dark mt-2" role="button" aria-pressed="true" value="Go Back" onclick="history.back(-1)">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/alfbriatna/sites/project/laskar_site/resources/views/settings/roles/edit.blade.php ENDPATH**/ ?>