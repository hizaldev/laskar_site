...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Update Data Diri dan Keanggotaan</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('update_profile.update__angggota', $item->id)}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="alert alert-warning" role="alert">
                                    <p>Silahkan pilih satu merchendise Laskar PLN, jika anda memilih lebih dari satu anda akan diarahkan untuk ke marketplace official Laskar PLN</p>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="warna">Pilih warna merchendize LASKAR PLN <span class="text-danger">*</span></label><br>
                                    <select name="warna" class="form-control @error('warna') is-invalid @enderror" id="warna" required><br>
                                        <option value="">-- Pilih Warna --</option>
                                        <option value="Biru">Biru</option>
                                        <option value="Merah">Merah</option>
                                        <option value="Merah">Kuning</option>
                                        <option value="Merah">Hitam</option>
                                        
                                    </select>

                                </div>
                                <div class="form-group mb-3">
                                    <label for="tempat_lahir">Ingin Warna Yang Lainnya?</label><br>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="to_marketplace" id="warna1" value="ya">
                                        <label class="form-check-label" for="warna">Ya</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="to_marketplace" id="warna2" value="tidak">
