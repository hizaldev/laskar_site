            ...
            <div class="col-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('sizes.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group mb-3">
                                <label for="ukuran">Ukuran Baju</label>
                                <input type="text" class="form-control form-control-sm @error('ukuran') is-invalid @enderror" value="{{$item->ukuran}}" name="ukuran" id="ukuran" placeholder="Masukan Data Ukuran Baju">
                                @error('ukuran')
