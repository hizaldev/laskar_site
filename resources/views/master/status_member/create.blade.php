        ...
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mb-4">
                    ...
                    @endif
                    <form action="{{ route('status_members.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="status">Status Anggota</label>
                            <input type="text" class="form-control form-control-sm @error('status') is-invalid @enderror" name="status" id="status" placeholder="Masukan Data Status Anggota">
                            @error('status')
