...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-center">
            <div class="col-4">
                <div class="card mb-4">
                    <div class="card-header"><strong>Edit Data Serikat Pekerja</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{{ route('unions.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group mb-3">
                                <label for="serikat_pekerja">Serikat Pekerja</label>
                                <input type="text" class="form-control form-control-sm @error('serikat_pekerja') is-invalid @enderror" value="{{$item->serikat_pekerja}}" name="serikat_pekerja" id="serikat_pekerja" placeholder="masukan Nama Serikat Pekerja">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control form-control-sm" name="alamat" id="alamat" placeholder="masukan Alamat" rows="5">{{$item->alamat}}</textarea>
                                @error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
