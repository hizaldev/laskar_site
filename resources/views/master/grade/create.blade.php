...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mb-4">
                    <div class="card-header"><strong>Tambah Data Grade</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                    ...
                    <form action="{{ route('grades.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <label for="dpd">Grade</label>
                            <input type="text" class="form-control form-control-sm @error('grade') is-invalid @enderror" name="grade" id="grade" placeholder="Masukan Data Grade">
                            @error('grade')
