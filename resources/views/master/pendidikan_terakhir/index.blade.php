...
@section('content')
    ...
    <div class="container-fluid px-5">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Data Pendidikan Terakhir</strong></div>
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm table-bordered table-hover w-100 table table-striped border datatable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Pendidikan Terakhir" data-column="1">
                                        </th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Keterangan" data-column="2">
                                        </th>
                                        @can('master_pendidikan_terakhir-edit')
                                            <th class="py-2"></th>
                                        @endcan
                                        @can('master_pendidikan_terakhir-delete')
                                            <th class="py-2"></th>
                                        @endcan
                                    </tr>
                                    <tr>
   ...
   <!-- Bootstrap 4 -->
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('master_pendidikan_terakhir-create')
                    {
                        text: "<i class='fa-solid fa-plus'></i>",
                        className: 'btn btn-primary mb-4 mr-2 text-white',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('last_educations.create') }}';
                        }        
                    },
                @endcan
                {
