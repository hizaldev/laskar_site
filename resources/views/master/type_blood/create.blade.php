        ...
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mb-4">
                    ...
                    @endif
                    <form action="{{ route('type_bloods.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="golongan_darah">Golongan Darah</label>
                            <input type="text" class="form-control form-control-sm @error('golongan_darah') is-invalid @enderror" name="golongan_darah" id="golongan_darah" placeholder="Masukan Data Golongan Darah">
                            @error('ukuran')
