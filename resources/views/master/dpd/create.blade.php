        ...
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mb-4">
                    ...
                    @endif
                    <form action="{{ route('dpd.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="dpd">DPD</label>
                            <input type="text" class="form-control form-control-sm @error('dpd') is-invalid @enderror" name="dpd" id="dpd" placeholder="masukan Nama DPD">
                            @error('dpd')
