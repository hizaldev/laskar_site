...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mb-4">
                    <div class="card-header"><strong>Tambah Data Sifat Dokumen</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('properties_documents.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="sifat_dokumen">Sifat Dokumen</label>
                            <input type="text" class="form-control form-control-sm @error('sifat_dokumen') is-invalid @enderror" name="sifat_dokumen" id="sifat_dokumen" placeholder="Masukan Data Sifat Dokumen">
                            @error('sifat_dokumen')
