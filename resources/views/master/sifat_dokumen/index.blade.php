...
@section('content')
    ...
    <div class="container-fluid px-5">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Data Sifat Dokumen</strong></div>
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm table-bordered table-hover w-100 table table-striped border datatable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Sifat Dokumen" data-column="1">
                                        </th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Keterangan" data-column="2">
                                        </th>
                                        @can('master_properties_document-edit')
                                            <th class="py-2"></th>
                                        @endcan
                                        @can('master_properties_document-delete')
                                            <th class="py-2"></th>
                                        @endcan
                                    </tr>
                                    <tr>
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            columns : [
                ...
                {data: 'sifat_dokumen', name: 'sifat_dokumen'},
            ...
            buttons : [ 
                @can('master_properties_document-create')
                    {
                        text: "<i class='fa-solid fa-plus'></i>",
                        className: 'btn btn-primary mb-4 mr-2 text-white',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('properties_documents.create') }}';
                        }        
                    },
                @endcan
                {
