...
@section('content')
    ...
    <div class="container-fluid px-5">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Data Management Link</strong></div>
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm table-bordered table-hover w-100 table table-striped border datatable">
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Nama Link" data-column="1">
                                        </th>
                                        <th> 
                                        </th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Urutan" data-column="3">
                                        </th>
                                        <th> 
                                            <input type="text" class="form-control filter-input form-control-sm" placeholder="Search Status" data-column="4">
                                        </th>
                                        @can('content_management_links-edit')
                                            <th class="py-2"></th>
                                        @endcan
                                        @can('content_management_links-delete')
                                            <th class="py-2"></th>
                                        @endcan
                                    </tr>
                                    <tr>
                                        <th class="py-2">Id</th>
                                        <th class="py-2">Nama Link</th>
                                        <th class="py-2">Icon</th>
                                        <th class="py-2">Urutan</th>
                                        <th class="py-2">Akti?</th>
                                        @can('content_management_links-edit')
                                            <th class="py-2"></th>
                                        @endcan
                                        @can('content_management_links-delete')
   ...
   <!-- Bootstrap 4 -->
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('content_management_links-create')
                    {
                        text: "<i class='fa-solid fa-plus'></i>",
                        className: 'btn btn-primary mb-4 mr-2 text-white',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('links.create') }}';
                        }        
                    },
                @endcan
                {
