...
@section('content')
    ...
    <div class="container-fluid px-5">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Data News Category</strong></div>
                    <div class="card-body">
                            ...
                            <table id="example" class="table table-sm table-bordered table-hover w-100 table table-striped border datatable">
                                <thead>
                                    <tr>
                                        ...
                                        @can('content_management_news_category-edit')
                                            <th class="py-2"></th>
                                        @endcan
                                        @can('content_management_news_category-delete')
                                            <th class="py-2"></th>
                                        @endcan
                                    </tr>
                                    <tr>
                                        <th class="py-2">Id</th>
                                        <th class="py-2">News Kategori</th>
                                        @can('content_management_news_category-edit')
                                            <th class="py-2"></th>
                                        @endcan
                                        @can('content_management_news_category-delete')
   ...
   <!-- Bootstrap 4 -->
    ...
    <script>
        var datatables = $('#example').DataTable({
            ...
            buttons : [ 
                @can('content_management_news_category-create')
                    {
                        text: "<i class='fa-solid fa-plus'></i>",
                        className: 'btn btn-primary mb-4 mr-2 text-white',
                        action: function ( e, dt, button, config ) {
                            window.location = '{{ route('news_category.create') }}';
                        }        
                    },
                @endcan
                {
