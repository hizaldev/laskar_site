...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="card mb-4">
                    <div class="card-header"><strong>Tambah Data Kategori Berita</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                    ...
                    <form action="{{ route('news_category.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('kategori_berita') is-invalid @enderror" name="kategori_berita" value="{{old('kategori_berita')}}" id="kategori_berita" placeholder="Masukan Nama Kategori Berita">
