...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-center">
            <div class="col-8">
                <div class="card mb-4">
                    <div class="card-header"><strong>Tambah Dokumen Laskar PLN</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                    ...
                    @endif
                    <form id="fileUploadForm" action="{{ route('documents.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                            <label for="no_document">Nomor Dokumen</label>
                            <input type="text" class="form-control form-control-sm @error('no_document') is-invalid @enderror" name="no_document" value="{{ old('no_document') }}" id="no_document" placeholder="Masukan No Dokumen">
                            @error('no_document')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm @error('perihal') is-invalid @enderror" name="perihal" value="{{ old('perihal') }}" id="perihal" placeholder="Masukan Perihal Dokumen">
                            @error('perihal')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control form-control-sm @error('tgl_document') is-invalid @enderror" name="tgl_document" value="{{ old('tgl_document') }}" id="tgl_document" placeholder="dd/mm/yyyy">
                            @error('tgl_document')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_public" id="Ya" value="Ya" checked>
                                    <label class="form-check-label" for="Ya">Ya</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_public" id="Tidak" value="Tidak">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="tipe_document" id="file" value="file" checked>
                                        <label class="form-check-label" for="file">File</label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="tipe_document" id="link" value="link">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control form-control-sm" name="location" id="location" placeholder="Lokasi Penyimpanan Arsip" rows="3"></textarea>
                            @error('location')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-3 desc" style="display: none;" id="tip_doklink">
                            ...
                            <input type="text" class="form-control form-control-sm @error('links') is-invalid @enderror desc" name="links" value="{{ old('links') }}" id="links" placeholder="Masukan Link Referensi Arsip">
                            @error('links')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <button type="submit" id="button" class="btn btn-success btn-sm mr-2 mt-2" >Submit</button>
