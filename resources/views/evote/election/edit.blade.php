...
@section('content')
    ...
    <div class="container-fluid px-4">
        <div class="row justify-content-center">
            <div class="col-4">
                <div class="card mb-4">
                    <div class="card-header"><strong>Edit Data Bank</strong></div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('banks.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm @error('bank') is-invalid @enderror" value="{{$item->bank}}" name="bank" id="bank" placeholder="Masukan Data Bank">
                                @error('bank')
